...
import{l as y}from"./chunk-6XZJ4HF4.mjs";import{a as h}from"./chunk-ABBCMJJI.mjs";import{V as d,_ as l,nd as m,ud as n}from"./chunk-I37AKPGM.mjs";import{a as f,b as u,h as c}from"./chunk-S6KH3LOX.mjs";var b=class s{supabase=h;_notificationsService=l(y);_httpClient=l(m);getUsers(){return c(this,arguments,function*(e=1,r=10,t={}){try{let a=(e-1)*r,g=a+r-1,o=this.supabase.from("profile").select(`
          id,
          fullName,
          email,
          country,
